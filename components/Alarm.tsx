...
const Alarm = ({ message, setMessage }: IAlarm) => {
            ...
            <div className="flex flex-col w-[500px] h-[275px] bg-white">
                <div className="p-4  h-2/3 flex flex-col">
                    <header className="pb-3 w-full border-b-[1px] border-gray-300 flex justify-between items-center">
                        ...
                        <svg onClick={onCloseAlarm} xmlns="http://www.w3.org/2000/svg" className="text-gray-400 h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                <div className="flex justify-center items-center bg-gray-100  flex-1">
                    <button onClick={onCloseAlarm} className="w-1/3 bg-purple-800 p-3 text-white">확인</button>
                </div>
            </div>
        </div>)
}
